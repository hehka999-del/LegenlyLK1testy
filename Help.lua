...
IslandFrame.Size = UDim2.fromOffset(190,50)
...
IslandLogo.Size = UDim2.fromOffset(34,34)
...
IslandText.Position = UDim2.fromOffset(51,0)
IslandText.Size = UDim2.new(1,-60,1,0)
IslandText.Text = "Troll HUB"
IslandText.Font = Enum.Font.GothamBold
IslandText.TextSize = 15
...
local function CreateToggle(parent,textKey,callback,default)
    ...
    switch.ZIndex = 110
    switch.Parent = frame
    RegisterForRecolor(switch,"BackgroundColor3")
    ...
    local controller = function(value)
        ...
        TweenService:Create(
            ...
            {
                Transparency = state and 0.08 or 1,
...
local function ApplySmoothFly()
    ...
    if moveDir.Magnitude > 0 then
        ...
        if horizontal.Magnitude > 0 then
            ...
            if camera then
                velocity += Vector3.new(0, camera.CFrame.LookVector.Y * TrollState.FlySpeed * 0.75, 0)
            end
        end
    end

    -- Keyboard and mobile jump button both request a clean vertical ascent.
    if UserInputService:IsKeyDown(Enum.KeyCode.Space) or TrollState.FlyVertical == 1 then
...
ThemeMainText.Position = UDim2.fromOffset(48,0)
ThemeMainText.Size = UDim2.new(1,-84,1,0)
...
ThemeMain.Activated:Connect(function()
    ...
    ThemeList.Size = themeOpen and UDim2.new(1,0,0,#ThemeOrder * 43 + 12) or UDim2.new(1,0,0,0)
